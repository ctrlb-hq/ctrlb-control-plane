...
type Operator interface {
	UpdateCurrentConfig(models.ConfigUpdateRequest) (map[string]string, error)
...
func (o *OperatorService) UpdateCurrentConfig(updateConfigRequest models.ConfigUpdateRequest) (interface{}, error) {
