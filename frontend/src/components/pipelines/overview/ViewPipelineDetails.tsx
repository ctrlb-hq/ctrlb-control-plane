...
import { IconButton, Button, Dialog, DialogActions, DialogTitle, DialogContent, DialogContentText, Drawer, Typography, } from "@mui/material";
  ...
  return (
    <>
		...
		>
			...
			{/* Header */}
				<div className="relative flex justify-between items-center px-10 py-3 border-b">
					...
					<Button variant="contained" color="primary">View/Edit Pipeline</Button>
				...
				<div className="border-b px-6">
					...
					{["overview", "yaml"].map(tab => (
						<li
						key={tab}
						className={`cursor-pointer py-2 ${
							tabs === tab ? "border-b-2 border-blue-500" : ""
						}`}
						onClick={() => setTabs(tab)}
						>
						{tab.toUpperCase()}
